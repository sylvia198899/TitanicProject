// Dead of the third class

var sliderAge = 0;
var radioSex = 0;

$(document).ready(function() {
    getvalue30(sliderAge, radioSex);
...
// draw the nodes of dead passengers in the third class
function getvalue30(Age, Sex){
  draw30(Age, Sex);
}

function draw30(Age, Sex){
  d3.select("#draw30").remove();
...
var svg3 = d3.select("#lower0").append("svg")
    .attr("width", width)
    .attr("height", height)
    .attr("id", "draw30");
...
//read the data from dead passengers in the third class
d3.json("30.json", function(error, json) {
  ...
  node.append("circle")
      ...
      .style("fill", function(d) { return fill3(d.group); });
